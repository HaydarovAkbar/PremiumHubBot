...
# from app.models import CustomUser, CustomUserAccount, TopUser  # o'z model yo'lingni tekshir!
#
#
...
from django.core.management.base import BaseCommand
from app.models import TopUser, CustomUserAccount


class Command(BaseCommand):
    help = "Update balances by dividing numeric fields by 100"

    def handle(self, *args, **kwargs):
        self.stdout.write("Updating TopUser balances...")
        ...
        self.stdout.write("Updating CustomUserAccount prices...")
